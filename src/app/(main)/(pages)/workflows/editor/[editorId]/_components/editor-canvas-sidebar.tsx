...
import { EditorCanvasDefaultCardTypes, CONNECTIONS } from "@/lib/constants";
import { useNodeConnections } from "@/providers/connections-providers";
import EditorCanvasIconHelper from "./editor-canvas-card-icon-helper";
import { fetchBotSlackChannels, onConnections, onDragStart } from "@/lib/editor-utils.ts";
...
const EditorCanvasSidebar = ({ nodes }: Props) => {
  ...
  const { nodeConnection } = useNodeConnections();
    const { googleFile, setSlackChannels } = useNexFlowStore();
    useEffect(() => {
      if (state) {
